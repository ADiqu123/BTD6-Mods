...
namespace ZapMonkey
{
    ...
    class Main : BloonsMod
    {
        ...
        public class ElectricShock : ModUpgrade<ZapMonkey>
        {
        ...
        public class JumperCables : ModUpgrade<ZapMonkey>
        {
        ...
        public class Provoker : ModUpgrade<ZapMonkey>
        {
        ...
        public class LightningSpike : ModUpgrade<ZapMonkey>
        {
        ...
        public class TheBeacon : ModUpgrade<ZapMonkey>
        {
        ...
        public class BlackLight : ModUpgrade<ZapMonkey>
        {
        ...
        public class DoubleProngs : ModUpgrade<ZapMonkey>
        {
        ...
        public class NegativeEnergy : ModUpgrade<ZapMonkey>
        {
            public override string Name => "Negative Energy";
            public override string DisplayName => "Negative Energy";
            public override string Description => "Attack becomes a bolt of negative energy knocking back bloons and dealing more damage.";
        ...
        public class BlackHoleGenerator : ModUpgrade<ZapMonkey>
        {
            public override string Name => "BlackHole Generator";
            public override string DisplayName => "BlackHole Generator";
            public override string Description => "Ability: Casts a black hole in range that absorbs a lot of bloons. Explodes into cash when full. Regular attack speed also increased.";
            ...
            public override void ApplyUpgrade(TowerModel towerModel)
            {
                ...
                towerModel.AddBehavior(Game.instance.model.GetTowerFromId("ObynGreenfoot 10").GetAbility(1).Duplicate());
                towerModel.GetAbility().Cooldown = 50.0f;
                var activate = towerModel.GetAbility().GetBehavior<ActivateAttackModel>().attacks[0];
                activate.weapons[0].projectile.display = "1d7a6094b3f142448b5c1a686b6a96d2";
                activate.weapons[0].projectile.GetBehavior<AgeModel>().Lifespan = 35.0f;
                activate.weapons[0].projectile.GetBehavior<WallOfTreesModel>().rbeCapacity = 4000;
        ...
        public class RiftMasterGeneral : ModUpgrade<ZapMonkey>
        {
            public override string Name => "Rift Master General";
            public override string DisplayName => "Rift Master General";
            public override string Description => "Spawns a super black hole that can absorb an enormous amount of bloons!";
            ...
            public override void ApplyUpgrade(TowerModel towerModel)
            {
                ...
                attackModel.weapons[0].projectile.pierce += 3;
                attackModel.weapons[0].projectile.GetBehavior<DamageModel>().damage += 3;
                towerModel.GetAbility().Cooldown = 35.0f;
                var activate = towerModel.GetAbility().GetBehavior<ActivateAttackModel>().attacks[0];
                activate.weapons[0].projectile.GetBehavior<AgeModel>().Lifespan = 25.0f;
                activate.weapons[0].projectile.GetBehavior<WallOfTreesModel>().rbeCapacity = 18000;

            }
            public override string Icon => "Riftmastergeneral_icon";
            public override string Portrait => "Riftmastergeneral";
        }
        public class BiggerBatteries : ModUpgrade<ZapMonkey>
        {
        ...
        public class TacticalCharging : ModUpgrade<ZapMonkey>
        {
        ...
        public class Buzzsaw : ModUpgrade<ZapMonkey>
        {
        ...
        public class AtomicShredder : ModUpgrade<ZapMonkey>
        {
        ...
        public class ParticleDissasembler : ModUpgrade<ZapMonkey>
        {
